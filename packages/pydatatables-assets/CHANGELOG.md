...
- We have renamed `dt_for_itables` to `pydatatables-assets` to make clear that it is used by our Python wrapper for `datatables.net` ([#625](https://github.com/mwouts/itables/issues/625), [#626](https://github.com/mwouts/itables/issues/626))
