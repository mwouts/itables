...
from pydatatables.typing import get_dataframe_module_name
...
def test_show_dtypes_pandas():
    ...
    assert (
        "<tr><th><small class='pydatatables-dtype'>i64</small></th><th><small class='pydatatables-dtype'>i64</small></th>"
    ...
    assert (
        f"<tr><th><small class='pydatatables-dtype'>{str_dtype}</small></th><th><small class='pydatatables-dtype'>i64</small></th><th><small class='pydatatables-dtype'>i64</small></th>"
        in table_html
    )
...
def test_long_strings_are_not_truncated(dataframe_library: str):
    """Test that long strings are passed verbatim to pydatatables for Pandas"""
    ...
    long_string = (
        "This is a very long string that should not be truncated by pydatatables formatting. "
        * 50
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # pandas nullable extension types - NaN is stored as pd.NA, encoded as null
        pytest.param(
            "pandas",
            "Float32",
            3.1415927410125732,
        ...
        # pandas ArrowDtype - NaN is stored as null, encoded as null
        pytest.param(
            "pandas",
            "arrow_float32",
            3.1415927410125732,
