...
try:
    from pydatatables.sample_pandas_dfs import (
...
def test_to_html_datatable(df_name, df):
    ...
    with (
        patch("pydatatables.javascript.pydatatables_version", "{pydatatables_version}"),
        patch(
            "pydatatables.options.dt_url",
            "https://www.unpkg.com/pydatatables@{dt_for_pydatatables_version}/dt_bundle.js",
        ),
    ):
