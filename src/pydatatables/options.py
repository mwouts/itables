"""
Default options for PyDataTablesRenderers.
...
import pydatatables.config as config
import pydatatables.typing as typing
import pydatatables.utils as utils
...
"""Display the PyDataTablesRenderers animated logo when loading"""
