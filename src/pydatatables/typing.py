...
def get_silence_msg(option_name: str) -> str:
    return (
        ...
        f"`pydatatables.options.{option_name}=False`. If you believe PyDataTablesOptions "
...
def check_itable_argument_types(kwargs: dict[str, Any], typed_dict: type) -> None:
    ...
    try:
        ...
        raise ImportError(
            ...
            "or deactivate the check by setting `pydatatables.options.warn_on_unexpected_option_type=False`."
        ) from e
