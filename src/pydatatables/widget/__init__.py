...
try:
    __version__ = importlib.metadata.version("pydatatables_anywidget")
except importlib.metadata.PackageNotFoundError:
    __version__ = "unknown"


class PyDataTablesRenderer(anywidget.AnyWidget):
    ...
    def update(
        ...
        **kwargs: Unpack[PyDataTablesOptions],
        ...
        # are always freshly computed by get_pydatatables_extension_arguments, so any
