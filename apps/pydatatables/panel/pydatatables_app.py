...
pixi run -e panel-app panel serve apps/panel/pydatatables_app.py
"""
...
table = DataTable(caption="A table rendered with ITable", select=True)
...
pn.template.FastListTemplate(
    ...
    logo="https://raw.githubusercontent.com/mwouts/pydatatables/main/src/pydatatables/logo/logo.svg",
    main=[
        table_tabs,
